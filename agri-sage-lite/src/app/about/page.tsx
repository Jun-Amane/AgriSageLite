        ...
        return (
                <Container maxWidth="lg">
                        ...
                        <Box sx={{ mt: 4, mb: 4 }}>
                                ...
                                <Typography variant="h5" component="h2" gutterBottom align="center" color="text.secondary" sx={{ fontFamily: "Noto Serif SC" }}>
                                        ～以人工智能赋能农业发展～
                                </Typography>
                                                ...
                                                <Card>
                                                        ...
                                                        <CardContent>
                                                                ...
                                                                <Typography variant="body1" color="text.secondary">
                                                                        AgriSageLite是一个旨在革新农业实践的前沿人工智能驱动解决方案。本平台基于轻量化的小样本多模态深度学习分类算法，为多样化的农业需求提供精确的分类和分析服务。
                                                                </Typography>
                                                        </CardContent>
                                                </Card>
                                        </Grid>
